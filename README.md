...
- ルートがキャッシュに無いうちに幾何だけで数えた機体は、**後から届いたルートが幾何と食い違って滑走路が外れたら、その記録を取り消します**（行が「出発・滑走路なし」に変わった機体を、着陸として数え続けないため）。進行方向が一時的に欠けて滑走路が決まらなくなっただけの機体は取り消さず、着陸して見えなくなった機体と同じく 10 分間数え続けます

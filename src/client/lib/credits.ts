...
/**
 * データ提供元のクレジット。仕様 §13 の列挙に、実際に使う adsb.fi・OpenSky Network・Planespotters.net を加えたもの。
 * OurAirports は Phase 1 では使わなかったので載せていなかったが、Phase 2 で滑走路データ
 * （src/server/data/runways.ts）に使うようになったので加えた（AC-P2-06）
 */
export const CREDITS: readonly Credit[] = [
  ...
  // 空港・滑走路データ（パブリックドメイン）。滑走路の推定の土台
  { id: "ourairports", label: "OurAirports（パブリックドメイン）", href: "https://ourairports.com" },
